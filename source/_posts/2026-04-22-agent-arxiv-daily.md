...
- **arXiv ID**: [2604.19638](https://arxiv.org/abs/2604.19638)
...
- **arXiv ID**: [2604.19567](https://arxiv.org/abs/2604.19567)
- **研究方向**: planning
- **核心要点**:
...
- **arXiv ID**: [2604.19488](https://arxiv.org/abs/2604.19488)
- **研究方向**: planning
- **核心要点**:
...
- **arXiv ID**: [2604.19459](https://arxiv.org/abs/2604.19459)
- **研究方向**: planning
- **核心要点**:
...
1. [A-MAR: Agent-based Multimodal Art Retrieval for Fine-Grained Artwork Understanding](https://arxiv.org/abs/2604.19689) - memory, planning
2. [SafetyALFRED: Evaluating Safety-Conscious Planning of Multimodal Large Language Models](https://arxiv.org/abs/2604.19638) - planning, safety
3. [Time Series Augmented Generation for Financial Applications](https://arxiv.org/abs/2604.19633) - other
4. [AblateCell: A Reproduce-then-Ablate Agent for Virtual Cell Repositories](https://arxiv.org/abs/2604.19606) - other
5. [Multi-modal Reasoning with LLMs for Visual Semantic Arithmetic](https://arxiv.org/abs/2604.19567) - planning
6. [Integrating Anomaly Detection into Agentic AI for Proactive Risk Management in Human Activity](https://arxiv.org/abs/2604.19538) - safety
7. [Revac: A Social Deduction Reasoning Agent](https://arxiv.org/abs/2604.19523) - memory, planning, multi_agent
8. [From Experience to Skill: Multi-Agent Generative Engine Optimization via Reusable Strategy Learning](https://arxiv.org/abs/2604.19516) - multi_agent
9. [CoDA: Towards Effective Cross-domain Knowledge Transfer via CoT-guided Domain Adaptation](https://arxiv.org/abs/2604.19488) - planning
10. [Do LLMs Game Formalization? Evaluating Faithfulness in Logical Reasoning](https://arxiv.org/abs/2604.19459) - planning
11. [Four-Axis Decision Alignment for Long-Horizon Enterprise AI Agents](https://arxiv.org/abs/2604.19457) - safety
12. [Do Agents Dream of Root Shells? Partial-Credit Evaluation of LLM Agents in Capture The Flag Challenges](https://arxiv.org/abs/2604.19354) - evaluation
13. [Explicit Trait Inference for Multi-Agent Coordination](https://arxiv.org/abs/2604.19278) - multi_agent
14. [ClawNet: Human-Symbiotic Agent Network for Cross-User Autonomous Cooperation](https://arxiv.org/abs/2604.19211) - other
15. [Reasoning-Aware AIGC Detection via Alignment and Reinforcement](https://arxiv.org/abs/2604.19172) - planning, safety
