...
description: "上一篇论证了 Agent 需要情绪——不是装饰性的\"喜怒哀乐\"，而是作为持续认知系统的功能性组件。但\"需要\"不等于\"有用\"，如果说不清楚情绪到底在 Agent 架构中干什么活，那它就还只是一个概念游戏。"
keywords: "情绪在agent中的四个功能, 情绪, agent, 认知科学, 持续认知, Agent 与情绪"
---
