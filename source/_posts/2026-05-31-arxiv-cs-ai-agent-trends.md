---
title: arXiv cs.AI 日报：Agent 领域最新趋势（2026-05-31）
tags:
  - arXiv
  - AI Agent
  - LLM
...
**论文**: [arXiv 2605.30353](https://arxiv.org/abs/2605.30353)
...
**论文**: [arXiv 2605.30335](https://arxiv.org/abs/2605.30335)
...
**论文**: [arXiv 2605.30159](https://arxiv.org/abs/2605.30159)
...
**论文**: [arXiv 2605.30219](https://arxiv.org/abs/2605.30219)
...
**论文**: [arXiv 2605.30144](https://arxiv.org/abs/2605.30144)

将学习建模为**状态转移**而非简单的角色扮演：
...
**论文**: [arXiv 2605.30136](https://arxiv.org/abs/2605.30136)

LLM 多 Agent 协作中，对话历史快速膨胀导致信息稀释：

- Agent-Radar：**无需训练**的上下文管理方法
- 时空衰减机制动态引导注意力到相关上下文
...
**论文**: [arXiv 2605.30283](https://arxiv.org/abs/2605.30283)
...
**论文**: [arXiv 2605.30187](https://arxiv.org/abs/2605.30187)

为教育场景设计模块化 Agent 架构：

- 单体 LLM 无法遵循教学理念，风险包括丧失迁移能力、批判性思维
- 提出**按练习解决阶段分模块**的架构，支持目标化教学建议
- 更可控、透明、可监督
...
**论文**: [arXiv 2605.30094](https://arxiv.org/abs/2605.30094)
...
**论文**: [arXiv 2605.30087](https://arxiv.org/abs/2605.30087)
...
1. **Agent 可靠性成为第一优先级**：从「能做事」到「做得对」，多篇论文聚焦 Agent 的可信度诊断与保障
2. **元认知是 Agent 进化的关键方向**：从 outcome-based reward 到 belief-level supervision，Agent 需要知道「自己不知道什么」
3. **多 Agent 从简单协作走向复杂社会模拟**：AgentSchool 展示了 Agent 模拟复杂社会动力学的能力
4. **结构化接口 > 纯 LLM 能力**：PokerSkill 和 MCP 的成功再次证明，给 LLM 合适的结构化接口比堆模型能力更有效
