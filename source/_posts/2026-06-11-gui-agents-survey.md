...
description: "图形用户界面（GUI）是人类与数字世界交互的主要通道——从桌面操作系统、移动 App 到 Web 应用，绝大多数信息流转都经过 GUI。长期以来，自动化 GUI 操作依赖脆弱的脚本和选择器，一丁点 UI 变动就全线崩溃。"
keywords: "大模型图形用户界面操作智能体（gui, agents）综述, 数据、架构、分类、应用、挑战, GUI Agents, LLM, 多模态, 智能体, 人机交互"
---
