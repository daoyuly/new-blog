...
- **arXiv ID**: [2605.16142](https://arxiv.org/abs/2605.16142)
...
- **arXiv ID**: [2605.16052](https://arxiv.org/abs/2605.16052)
- **研究方向**: planning, evaluation
- **核心要点**:
...
- **arXiv ID**: [2605.15975](https://arxiv.org/abs/2605.15975)
- **研究方向**: planning
- **核心要点**:
...
- **arXiv ID**: [2605.15967](https://arxiv.org/abs/2605.15967)
- **研究方向**: planning
- **核心要点**:
...
- **arXiv ID**: [2605.15960](https://arxiv.org/abs/2605.15960)
- **研究方向**: planning
- **核心要点**:
...
1. [FORGE: Self-Evolving Agent Memory With No Weight Updates via Population Broadcast](https://arxiv.org/abs/2605.16233) - memory
2. [Confirming Correct, Missing the Rest: LLM Tutoring Agents Struggle Where Feedback Matters Most](https://arxiv.org/abs/2605.16207) - other
3. [Context, Reasoning, and Hierarchy: A Cost-Performance Study of Compound LLM Agent Design in an Adversarial POMDP](https://arxiv.org/abs/2605.16205) - planning
4. [Look Before You Leap: Autonomous Exploration for LLM Agents](https://arxiv.org/abs/2605.16143) - other
5. [Property-Guided LLM Program Synthesis for Planning](https://arxiv.org/abs/2605.16142) - planning, evaluation
6. [ShopGym: An Integrated Framework for Realistic Simulation and Scalable Benchmarking of E-Commerce Web Agents](https://arxiv.org/abs/2605.16116) - evaluation
7. [Reasoners or Translators? Contamination-aware Evaluation and Neuro-Symbolic Robustness in Tax Law](https://arxiv.org/abs/2605.16052) - planning, evaluation
8. [Learning Bilevel Policies over Symbolic World Models for Long-Horizon Planning](https://arxiv.org/abs/2605.15975) - planning
9. [Deterministic Event-Graph Substrates as World Models for Counterfactual Reasoning](https://arxiv.org/abs/2605.15967) - planning
10. [Imperfect World Models are Exploitable](https://arxiv.org/abs/2605.15960) - planning
11. [Agentic Discovery of Neural Architectures: AIRA-Compose and AIRA-Design](https://arxiv.org/abs/2605.15871) - other
12. [SaaS-Bench: Can Computer-Use Agents Leverage Real-World SaaS to Solve Professional Workflows?](https://arxiv.org/abs/2605.15777) - memory
13. [ALSO: Adversarial Online Strategy Optimization for Social Agents](https://arxiv.org/abs/2605.15768) - other
14. [ColPackAgent: Agent-Skill-Guided Hard-Particle Monte Carlo Workflows for Colloidal Packing](https://arxiv.org/abs/2605.15625) - other
