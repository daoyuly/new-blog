...
- **arXiv ID**: [2605.22720](https://arxiv.org/abs/2605.22720)
- **研究方向**: safety
- **核心要点**:
...
- **arXiv ID**: [2605.22511](https://arxiv.org/abs/2605.22511)
- **研究方向**: planning
- **核心要点**:
...
1. [MOSS: Self-Evolution through Source-Level Rewriting in Autonomous Agent Systems](https://arxiv.org/abs/2605.22794) - other
...
3. [Advancing Mathematics Research with AI-Driven Formal Proof Search](https://arxiv.org/abs/2605.22763) - other
4. [Can AI Make Conflicts Worse? An Alignment Failure in LLM Deployment Across Conflict Contexts](https://arxiv.org/abs/2605.22720) - safety
5. [WorkstreamBench: Evaluating LLM Agents on End-to-End Spreadsheet Tasks in Finance](https://arxiv.org/abs/2605.22664) - other
6. [Claw AI Lab: An Autonomous Multi-Agent Research Team](https://arxiv.org/abs/2605.22662) - multi_agent
7. [AtelierEval: Agentic Evaluation of Humans &amp; LLMs as Text-to-Image Prompters](https://arxiv.org/abs/2605.22645) - evaluation
8. [Spreadsheet-RL: Advancing Large Language Model Agents on Realistic Spreadsheet Tasks via Reinforcement Learning](https://arxiv.org/abs/2605.22642) - other
9. [Think Thrice Before You Speak: Dual knowledge-enhanced Theory-of-Mind Reasoning for Persuasive Agents](https://arxiv.org/abs/2605.22602) - planning
10. [TerminalWorld: Benchmarking Agents on Real-World Terminal Tasks](https://arxiv.org/abs/2605.22535) - evaluation
11. [Search-E1: Self-Distillation Drives Self-Evolution in Search-Augmented Reasoning](https://arxiv.org/abs/2605.22511) - planning
12. [Towards Direct Evaluation of Harness Optimizers via Priority Ranking](https://arxiv.org/abs/2605.22505) - evaluation
