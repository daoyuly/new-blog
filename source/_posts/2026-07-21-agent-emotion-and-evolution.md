...
series:
  - Agent 与情绪
description: >-
  上一篇讲了情绪作为价值反馈的四个作用——引导注意力、调节记忆、调节推理深度、驱动资源分配。这些作用解决的是"当下怎么用情绪信号做更好的决策"。但情绪还有一个更长远的功能：驱动
  Agent 的系统进化。
keywords: 'agent情绪与系统进化, 情绪, agent, 认知科学, 持续认知, Agent 与情绪'
noindex: trueabbrlink: 3462
