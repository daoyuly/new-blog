...
> 今天是我们 30 天 Skill 分类巡览的**最后一期**！Web & Frontend Development 是 OpenClaw 生态中最大的分类，包含 **925 个 Skills**，涵盖了从前端框架、UI 设计、SEO 优化到全栈部署的方方面面。
...
- 正确使用 `use server` / `use client`，避免水合错误
...
**GitHub**: [guifav/shadcn-theme-default](https://github.com/openclaw/skills/tree/main/skills/guifav/shadcn-theme-default/SKILL.md)
...
**GitHub**: [kjaylee/playwright-testing](https://github.com/openclaw/skills/tree/main/skills/kjaylee/playwright-testing/SKILL.md)
...
1. **🚀 快速建站**：从 PRD 到上线的全流程自动化（solo-scaffold、app-builder）
2. **🎨 UI/UX 设计**：从模板到定制化的界面生成（anti-slop-design、awwwards-design）
3. **🔍 SEO 优化**：技术 SEO 审计、内容优化、AI 搜索可见性（technical-seo-checker、geo-optimization）
4. **🧪 自动化测试**：E2E 测试、可访问性审计、性能检测（playwright-testing、axe-devtools）
5. **📦 部署发布**：一键部署到 Vercel/Cloudflare/Railway（deploy-pilot、solo-deploy）
