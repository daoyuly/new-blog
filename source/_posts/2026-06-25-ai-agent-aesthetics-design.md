...
description: "做 AI Agent 的人经常聊能力——推理、工具调用、记忆、多轮对话。但很少有人聊美感。这很奇怪，因为 Agent 和用户的交互界面就是对话本身，对话的美感直接决定用户愿不愿意继续用、信不信你、甚至喜不喜欢你。"
keywords: "agent, 的美学, 对话里的设计原则与实践, AI, Agent, 美学, 对话设计, 用户体验"
---
