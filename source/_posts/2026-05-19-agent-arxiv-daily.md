...
- **arXiv ID**: [2605.18693](https://arxiv.org/abs/2605.18693)
- **研究方向**: evaluation
- **核心要点**:
...
- **arXiv ID**: [2605.18663](https://arxiv.org/abs/2605.18663)
...
- **arXiv ID**: [2605.18630](https://arxiv.org/abs/2605.18630)
- **研究方向**: evaluation
- **核心要点**:
...
- **arXiv ID**: [2605.18380](https://arxiv.org/abs/2605.18380)
- **研究方向**: planning, evaluation
- **核心要点**:
...
- **arXiv ID**: [2605.18327](https://arxiv.org/abs/2605.18327)
- **研究方向**: evaluation
- **核心要点**:
...
- **arXiv ID**: [2605.18194](https://arxiv.org/abs/2605.18194)
- **研究方向**: evaluation
- **核心要点**:
...
- **arXiv ID**: [2605.18674](https://arxiv.org/abs/2605.18674)
- **研究方向**: planning
- **核心要点**:
...
- **arXiv ID**: [2605.18570](https://arxiv.org/abs/2605.18570)
...
- **arXiv ID**: [2605.18299](https://arxiv.org/abs/2605.18299)
- **研究方向**: planning
- **核心要点**:
...
- **arXiv ID**: [2605.18672](https://arxiv.org/abs/2605.18672)
- **研究方向**: safety
- **核心要点**:
...
- **arXiv ID**: [2605.18597](https://arxiv.org/abs/2605.18597)
- **研究方向**: other
- **核心要点**:
...
1. [SkillGenBench: Benchmarking Skill Generation Pipelines for LLM Agents](https://arxiv.org/abs/2605.18693) - evaluation
2. [Efficient Lookahead Encoding and Abstracted Width for Learning General Policies in Classical Planning](https://arxiv.org/abs/2605.18674) - planning
3. [Position: A Three-Layer Probabilistic Assume-Guarantee Architecture Is Structurally Required for Safe LLM Agent Deployment](https://arxiv.org/abs/2605.18672) - safety
4. [GIM: Evaluating models via tasks that integrate multiple cognitive domains](https://arxiv.org/abs/2605.18663) - planning, evaluation
5. [AI for Auto-Research: Roadmap &amp; User Guide](https://arxiv.org/abs/2605.18661) - other
6. [SCICONVBENCH: Benchmarking LLMs on Multi-Turn Clarification for Task Formulation in Computational Science](https://arxiv.org/abs/2605.18630) - evaluation
7. [Latent Action Reparameterization for Efficient Agent Inference](https://arxiv.org/abs/2605.18597) - other
8. [Query-Conditioned Knowledge Alignment for Reliable Cross-System Medical Reasoning](https://arxiv.org/abs/2605.18570) - planning, safety
9. [QSTRBench: a New Benchmark to Evaluate the Ability of Language Models to Reason with Qualitative Spatial and Temporal Calculi](https://arxiv.org/abs/2605.18380) - planning, evaluation
10. [Causely: A Causal Intelligence Layer for Enterprise AI A Benchmark Study on SRE and Reliability Workflows](https://arxiv.org/abs/2605.18327) - evaluation
11. [SD-Search: On-Policy Hindsight Self-Distillation for Search-Augmented Reasoning](https://arxiv.org/abs/2605.18299) - planning
12. [Beyond the Cartesian Illusion: Testing Two-Stage Multi-Modal Theory of Mind under Perceptual Bottlenecks](https://arxiv.org/abs/2605.18194) - evaluation
