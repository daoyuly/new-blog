...
### [MLEvolve](https://arxiv.org/abs/2606.06473) — 自进化多 Agent 框架，自动发现 ML 算法
...
### [Agent Memory](https://arxiv.org/abs/2606.06448) — 首个 Agent 记忆系统的系统级刻画
...
### [TokenMizer](https://arxiv.org/abs/2606.06337) — 图结构会话记忆，长程上下文管理
...
### [DataCOPE](https://arxiv.org/abs/2606.06416) — 无监督技能发现，提升数据分析 Agent
...
### [DragOn](https://arxiv.org/abs/2606.06322) — 拖拽交互 Benchmark
...
### [Benchmark Agent](https://arxiv.org/abs/2606.06462) — 全自动 Benchmark 构建系统
...
### [Vortex](https://arxiv.org/abs/2606.06453) — 可编程稀疏注意力服务系统
...
### [ALMANAC](https://arxiv.org/abs/2606.06388) — 人类协作数据集，带动作级心智模型标注
...
### [Goedel-Architect](https://arxiv.org/abs/2606.06468) — 蓝图生成与精化的形式化定理证明 Agent
