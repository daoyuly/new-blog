...
description: "2026-06-02 Agent Harness 领域监测：16项动态，框架与运行时8项、评测与可观测4项、多智能体协作4项。基于Agent Harness成熟度模型(AHMM)和编排四范式分析。核心判断：MCP成为工具接入事实标准，L2→L3是当前最大跳跃。"
...
| 项目/论文 | 来源 | 核心描述 | 工程启示 |
|-----------|------|---------|----------|
| [MCP-Persona: Benchmarking LLM Agents on ](https://arxiv.org/abs/2606.02470) | arXiv | mcp,persona,wwh0411,personal,tools,feishu,applications,xiaoh | MCP 生态值得关注 |
| [AGENTCL: Toward Rigorous Evaluation of C](https://arxiv.org/abs/2606.02461) | arXiv | continual,streams,agentcl,naive,agents,memory,language,desig | 评估闭环是关键 |
| [Food Noise &amp; False Safety: A Systema](https://arxiv.org/abs/2606.02444) | arXiv | uncritically,eating,adapt,eds,llms,advice,unsafe,clinician,c | 评估闭环是关键 |
| [Show HN: VoltAgent – Open-Source Observa](https://github.com/VoltAgent/voltagent) | HN | Show HN: VoltAgent – Open-Source Observability-First TS AI A | 向L3可观测演进 |
...
| 项目/论文 | 来源 | 核心描述 | 工程启示 |
|-----------|------|---------|----------|
| [MOC: Multi-Order Communication in LLM-ba](https://arxiv.org/abs/2606.02359) | arXiv | moc,communication,multi,llm,agent,hop,order,guan,underexplor | 多Agent协作框架演进 |
| [Coordination Graphs for Constrained Mult](https://arxiv.org/abs/2606.02337) | arXiv | cmarl,coordination,agents,constrained,agent,reinforcement,gr | DAG编排成主流 |
| [POIROT: Interrogating Agents for Failure](https://arxiv.org/abs/2606.02282) | arXiv | poirot,agent,fault,agents,interrogating,failure,safety,exter | 多Agent协作框架演进 |
| [Fabrice AI: Multi-Agent Framework for Ty](https://github.com/callstackincubator/fabrice-ai) | HN | Fabrice AI: Multi-Agent Framework for TypeScript | 多Agent协作框架演进 |
...
| 项目/论文 | 来源 | 核心描述 | 工程启示 |
|-----------|------|---------|----------|
| [Tracking the Behavioral Trajectories of ](https://arxiv.org/abs/2606.02536) | arXiv | files,skill,agent,diffs,trait,behavioral,agents,edits,embedd | 关注架构演进方向 |
| [AGENTCL: Toward Rigorous Evaluation of C](https://arxiv.org/abs/2606.02461) | arXiv | continual,streams,agentcl,naive,agents,memory,language,desig | 评估闭环是关键 |
...
| 项目/论文 | 来源 | 核心描述 | 工程启示 |
|-----------|------|---------|----------|
| [HLL: Can Agents Cross Humanity&#039;s La](https://arxiv.org/abs/2606.02449) | arXiv | hll,agents,captcha,verification,humanity,multimodal,human,wo | DAG编排成主流 |
