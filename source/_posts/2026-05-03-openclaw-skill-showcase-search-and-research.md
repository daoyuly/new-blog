...
description: "搜索与研究 分类是 OpenClaw 生态中最为重要的分类之一，共包含 352 个 skills。这个分类汇集了从学术研究到商业情报、从数据检索到深度分析的各类工具，是 AI 代理获取外部知识和进行信息处理的核心能力集。"
...
**GitHub**: [openclaw/skills](https://github.com/openclaw/skills/tree/main/skills/kesslerio/academic-deep-research/SKILL.md)
...
**GitHub**: [openclaw/skills](https://github.com/openclaw/skills/tree/main/skills/24601/agent-deep-research/SKILL.md)
...
**GitHub**: [openclaw/skills](https://github.com/openclaw/skills/tree/main/skills/ericsantos/perplexity-deep-search/SKILL.md)
...
**GitHub**: [openclaw/skills](https://github.com/openclaw/skills/tree/main/skills/c5huracan/meyhem-researcher/SKILL.md)
...
**GitHub**: [openclaw/skills](https://github.com/openclaw/skills/tree/main/skills/ttboy/deeps/SKILL.md)
...
### 新手入门
1. 从 **perplexity-deep-search** 开始，快速体验智能搜索
2. 配置一个持久化记忆系统（推荐 **engram-memory**）
3. 根据具体需求选择专业搜索工具
