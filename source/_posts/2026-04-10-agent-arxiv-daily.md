...
- **arXiv ID**: [2604.07236](https://arxiv.org/abs/2604.07236)
- **研究方向**: planning
- **核心要点**:
...
- **arXiv ID**: [2604.07165](https://arxiv.org/abs/2604.07165)
- **研究方向**: planning
- **核心要点**:
...
- **arXiv ID**: [2604.07042](https://arxiv.org/abs/2604.07042)
- **研究方向**: planning
- **核心要点**:
...
- **arXiv ID**: [2604.06995](https://arxiv.org/abs/2604.06995)
- **研究方向**: planning
- **核心要点**:
...
- **arXiv ID**: [2604.06802](https://arxiv.org/abs/2604.06802)
...
- **arXiv ID**: [2604.06695](https://arxiv.org/abs/2604.06695)
- **研究方向**: planning
- **核心要点**:
...
- **arXiv ID**: [2604.06401](https://arxiv.org/abs/2604.06401)
- **研究方向**: planning
- **核心要点**:
...
- **arXiv ID**: [2604.06389](https://arxiv.org/abs/2604.06389)
- **研究方向**: planning
- **核心要点**:
...
- **arXiv ID**: [2604.06375](https://arxiv.org/abs/2604.06375)
- **研究方向**: planning
- **核心要点**:
...
- **arXiv ID**: [2604.07070](https://arxiv.org/abs/2604.07070)
- **研究方向**: evaluation
- **核心要点**:
...
- **arXiv ID**: [2604.07017](https://arxiv.org/abs/2604.07017)
...
- **arXiv ID**: [2604.07009](https://arxiv.org/abs/2604.07009)
- **研究方向**: memory
- **核心要点**:
...
- **arXiv ID**: [2604.07003](https://arxiv.org/abs/2604.07003)
- **研究方向**: multi_agent
- **核心要点**:
...
- **arXiv ID**: [2604.06747](https://arxiv.org/abs/2604.06747)
- **研究方向**: multi_agent
- **核心要点**:
...
- **arXiv ID**: [2604.06691](https://arxiv.org/abs/2604.06691)
- **研究方向**: multi_agent
- **核心要点**:
...
- **arXiv ID**: [2604.06779](https://arxiv.org/abs/2604.06779)
- **研究方向**: safety
- **核心要点**:
...
- **arXiv ID**: [2604.06696](https://arxiv.org/abs/2604.06696)
- **研究方向**: other
- **核心要点**:
...
- **arXiv ID**: [2604.06562](https://arxiv.org/abs/2604.06562)
- **研究方向**: other
- **核心要点**:
...
1. [How Much LLM Does a Self-Revising Agent Actually Need?](https://arxiv.org/abs/2604.07236) - planning
2. [Reason in Chains, Learn in Trees: Self-Rectification and Grafting for Multi-turn Agent Policy Optimization](https://arxiv.org/abs/2604.07165) - planning
3. [EVGeoQA: Benchmarking LLMs on Dynamic, Multi-Objective Geo-Spatial Exploration](https://arxiv.org/abs/2604.07070) - evaluation
4. [Planning Task Shielding: Detecting and Repairing Flaws in Planning Tasks through Turning them Unsolvable](https://arxiv.org/abs/2604.07042) - planning
5. [A-MBER: Affective Memory Benchmark for Emotion Recognition](https://arxiv.org/abs/2604.07017) - memory, evaluation
6. [CAFP: A Post-Processing Framework for Group Fairness via Counterfactual Model Averaging](https://arxiv.org/abs/2604.07009) - memory
7. [EmoMAS: Emotion-Aware Multi-Agent System for High-Stakes Edge-Deployable Negotiation with Bayesian Orchestration](https://arxiv.org/abs/2604.07003) - multi_agent
8. [What&#039;s Missing in Screen-to-Action? Towards a UI-in-the-Loop Paradigm for Multimodal GUI Reasoning](https://arxiv.org/abs/2604.06995) - planning
9. [Riemann-Bench: A Benchmark for Moonshot Mathematics](https://arxiv.org/abs/2604.06802) - planning, evaluation
10. [FVD: Inference-Time Alignment of Diffusion Models via Fleming-Viot Resampling](https://arxiv.org/abs/2604.06779) - safety
11. [TurboAgent: An LLM-Driven Autonomous Multi-Agent Framework for Turbomachinery Aerodynamic Design](https://arxiv.org/abs/2604.06747) - multi_agent
12. [AgentGate: A Lightweight Structured Routing Engine for the Internet of Agents](https://arxiv.org/abs/2604.06696) - other
13. [Reasoning Fails Where Step Flow Breaks](https://arxiv.org/abs/2604.06695) - planning
14. [KD-MARL: Resource-Aware Knowledge Distillation in Multi-Agent Reinforcement Learning](https://arxiv.org/abs/2604.06691) - multi_agent
15. [Rethinking Generalization in Reasoning SFT: A Conditional Analysis on Optimization, Data, and Model Capability](https://arxiv.org/abs/2604.06628) - planning
16. [On Emotion-Sensitive Decision Making of Small Language Model Agents](https://arxiv.org/abs/2604.06562) - other
17. [ProofSketcher: Hybrid LLM + Lightweight Proof Checker for Reliable Math/Logic Reasoning](https://arxiv.org/abs/2604.06401) - planning
18. [Qualixar OS: A Universal Operating System for AI Agent Orchestration](https://arxiv.org/abs/2604.06392) - other
19. [SELFDOUBT: Uncertainty Quantification for Reasoning LLMs via the Hedge-to-Verify Ratio](https://arxiv.org/abs/2604.06389) - planning
20. [SymptomWise: A Deterministic Reasoning Layer for Reliable and Efficient AI Systems](https://arxiv.org/abs/2604.06375) - planning
