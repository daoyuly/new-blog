---
title: Agent 前沿日报 2025.05.25 — Agent 技能自进化、多智能体协调与安全审计
date: '2026-05-25 12:11:00 +0800'
tags:
  - arxiv
  - agent
  - AI趋势
...
**[EVE-Agent: Evidence-Verifiable Self-Evolving Agents](https://arxiv.org/abs/2605.23204)**
...
来自 MetaGPT 团队的大作。随着 Agent 从工具走向社会基础设施，瓶颈从模型能力转向**协调**。
...
### 5. 多 Agent 规划的认知校准
**[When Planning Fails Despite Correct Execution](https://arxiv.org/abs/2605.23414)**
...
### 6. 人机闭环多 Agent 呼吸机决策
**[Human-in-the-Loop Multi-Agent Ventilator Decision Support](https://arxiv.org/abs/2605.23320)**

医疗场景下的多 Agent 协作，使用 contextual bandit 学习临床医生偏好。

### 7. 战略推理评估
**[GENSTRAT: Toward a Science of Strategic Reasoning in LLMs](https://arxiv.org/abs/2605.23238)**
...
**[Redrawing the AI Map: A Theory of Accountability Boundaries](https://arxiv.org/abs/2605.23179)**
...
### 12. PathCal：推理路径校准
**[PathCal: State-Aware Reflection-Marker Calibration](https://arxiv.org/abs/2605.23238)**
...
### 15. 自动科研 Agent 综述
**[AutoResearch AI](https://arxiv.org/abs/2605.23204)**
...
### 16. 可验证系统的归纳-演绎合成
**[Inductive Deductive Synthesis](https://arxiv.org/abs/2605.23204)**
...
1. **技能优化走向工程化**：SkillOpt 把 Agent 技能训练做到了深度学习级别的严谨性，这可能是 Agent 从"能用"到"可靠"的关键一步。

2. **协调 > 能力**：Foundation Protocol 代表了一个重要转向——Agent 领域的瓶颈正在从单 Agent 能力转向多 Agent 协调和社会化基础设施。

3. **安全审计从预防走向事后**：MemAudit 证明了事后因果审计的可行性，Agent 安全正在形成完整的攻防体系。

4. **推理控制精细化**：Co-ReAct 和 PathCal 代表了推理控制从粗粒度到细粒度的趋势——每一步都有针对性的引导。

5. **科研自动化加速**：AutoResearch 和 IDS 两篇论文共同指向一个方向——AI 正在从辅助科研走向自动化科研工作流。
