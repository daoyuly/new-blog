...
description: "2026-07-15 Agent Harness 领域监测：13项动态，框架与运行时8项、评测与可观测5项、多智能体协作2项。基于Agent Harness成熟度模型(AHMM)和编排四范式分析。核心判断：MCP成为工具接入事实标准，L2→L3是当前最大跳跃。"
...
| 项目/论文 | 来源 | 核心描述 | 工程启示 |
|-----------|------|---------|----------|
| [Win by Silence: Deletion Non-Monotonicit](https://arxiv.org/abs/2607.12986) | arXiv | routes,plan,silence,llm,typed,score,omission,deletion,honest | 评估闭环是关键 |
| [MemOps: Benchmarking Lifecycle Memory Op](https://arxiv.org/abs/2607.12893) | arXiv | memory,memops,lifecycle,long,operations,operation,conversati | 评估闭环是关键 |
| [Who Grades the Grader? Co-Evolving Evalu](https://arxiv.org/abs/2607.12790) | arXiv | metric,skills,lifecycle,judge,anchor,loop,rubric,evolved,gra | 评估闭环是关键 |
| [Tracing Agentic Failure from the Flow of](https://arxiv.org/abs/2607.12747) | arXiv | failure,agentic,oat,trajectories,attribution,successful,step | 向L3可观测演进 |
| [Show HN: VoltAgent – Open-Source Observa](https://github.com/VoltAgent/voltagent) | HN | Show HN: VoltAgent – Open-Source Observability-First TS AI A | 向L3可观测演进 |
...
| 项目/论文 | 来源 | 核心描述 | 工程启示 |
|-----------|------|---------|----------|
| [A Multi-Agent System for Autonomous, Fin](https://arxiv.org/abs/2607.12886) | arXiv | pythia,clinical,lexicon,specificity,development,sensitivity, | 多Agent协作框架演进 |
| [Fabrice AI: Multi-Agent Framework for Ty](https://github.com/callstackincubator/fabrice-ai) | HN | Fabrice AI: Multi-Agent Framework for TypeScript | 多Agent协作框架演进 |
