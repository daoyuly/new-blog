...
| # | 标题 | arXiv ID | 相关度 | 关键词 |
|---|------|----------|--------|--------|
| 1 | **From Atomic Actions to Standard Operating Procedures: Iterative Tool Optimization for Self-Evolving LLM Agents** | [2607.07321](https://arxiv.org/abs/2607.07321) | ⭐⭐⭐ | self-evolving, experience accumulation, SOP extraction |
| 2 | **The Blind Curator: How a Biased Judge Silently Disables Skill Retirement in Self-Evolving Agents** | [2607.07436](https://arxiv.org/abs/2607.07436) | ⭐⭐⭐ | skill library, memory curation, reward bias |
| 3 | **SkillCenter: A Large-Scale Source-Grounded Skill Library for Autonomous AI Agents** | [2607.07676](https://arxiv.org/abs/2607.07676) | ⭐⭐ | skill memory, knowledge base, FTS5 search |
| 4 | **Large Behavior Model: A Promptable Digital Twin of the Retail Customer** | [2607.06993](https://arxiv.org/abs/2607.06993) | ⭐⭐ | RAG, behavioral profile, historical memory |
| 5 | **SpaCellAgent: A Self-Evolving LLM-Based Multi-Agent Framework for Trajectory Analysis** | [2607.07467](https://arxiv.org/abs/2607.07467) | ⭐⭐ | self-evolution module, feedback refinement |
| 6 | **Recursive Self-Improvement in AI: From Bounded Self-Refinement to Autonomous Research Loops** | [2607.07663](https://arxiv.org/abs/2607.07663) | ⭐ | self-improvement, evaluator design, loop closure |
| 7 | **The Harness Effect: How Orchestration Design Sets the Token Economics of Enterprise Agentic AI** | [2607.06906](https://arxiv.org/abs/2607.06906) | ⭐ | context management, orchestration layer |
