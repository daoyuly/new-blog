...
description: "上一篇讲了情绪在 Agent 中的四个功能——价值反馈、状态调节、资源分配、行为选择。这些功能的前提是 Agent 能感知到情绪信号。但感知自己的情绪是一回事，感知人的情绪是另一回事。"
keywords: "agent如何感知人的情绪, 情绪, agent, 认知科学, 持续认知, Agent 与情绪"
---
