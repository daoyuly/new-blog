...
series:
  - Agent 与情绪
description: 上一篇讲了状态管理——更新、传播、衰减、恢复。这是情绪系统的"运维"层面。但运维不是目的，情绪存在的根本原因是它为持续认知提供价值反馈。
keywords: '情绪作为持续认知的价值反馈, 情绪, agent, 认知科学, 持续认知, Agent 与情绪'
noindex: trueabbrlink: 32743
