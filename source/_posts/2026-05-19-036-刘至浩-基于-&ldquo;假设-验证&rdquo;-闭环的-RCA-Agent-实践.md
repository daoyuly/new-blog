...
description: "在微服务架构下，故障根因分析（RCA）一直是SRE与运维团队的核心痛点。随着大模型的普及，构建RCA Agent实现自动化排障似乎成了顺理成章的解法。然而，理想很丰满，现实却往往骨感：当前的AI Agent在复杂生产环境中极易产生幻觉..."
keywords: "基于假设, 验证闭环的rca, agent实践, 让排障告别“脑补”, 技术蒸馏, TKDE, 技术思考"
---
