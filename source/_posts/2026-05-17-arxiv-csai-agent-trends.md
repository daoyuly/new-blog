...
**论文：** [Orchard: An Open-Source Agentic Modeling Framework](https://arxiv.org/abs/2605.15040)（#6）
...
**论文：** [OpenDeepThink: Parallel Reasoning via Bradley--Terry Aggregation](https://arxiv.org/abs/2605.15177)（#1）
...
**论文：** [APWA: A Distributed Architecture for Parallelizable Agentic Workflows](https://arxiv.org/abs/2605.15132)（#2）
...
**论文：** [Dual-Dimensional Consistency: Balancing Budget and Quality in Adaptive Inference-Time Scaling](https://arxiv.org/abs/2605.15100)（#4）
...
**论文：** [Case-Based Calibration of Adaptive Reasoning and Execution for LLM Tool Use](https://arxiv.org/abs/2605.15041)（#5）
...
**论文：** [Beyond Individual Intelligence: Surveying Collaboration, Failure Attribution, and Self-Evolution in LLM-based Multi-Agent Systems](https://arxiv.org/abs/2605.14892)（#14）
...
**论文：** [Holistic Evaluation and Failure Diagnosis of AI Agents](https://arxiv.org/abs/2605.14865)（#16）
...
**论文：** [GraphFlow: An Architecture for Formally Verifiable Visual Workflows Enabling Reliable Agentic AI Automation](https://arxiv.org/abs/2605.14968)（#10）
...
| # | 论文 | 关键词 | 亮点 |
|---|------|--------|------|
| 1 | [OpenDeepThink](https://arxiv.org/abs/2605.15177) | Test-time Compute, 并行推理 | Bradley-Terry 聚合选择，Codeforces Elo +405 |
| 2 | [APWA](https://arxiv.org/abs/2605.15132) | 分布式多 Agent, 并行工作流 | 工作流分解为无干扰子问题并行处理 |
| 3 | [Agentic GraphRAG](https://arxiv.org/abs/2605.15109) | GraphRAG, 引文忠实性 | 引文评估应从源支持转向检索轨迹溯源 |
| 4 | [DDC](https://arxiv.org/abs/2605.15100) | 推理时缩放, 自适应终止 | Token 消耗降 10x+，准确率保持 |
| 5 | [CAST](https://arxiv.org/abs/2605.15041) | 工具使用, 案例推理 | 执行准确率 +5.85pp，推理长度 -26% |
| 6 | [Orchard](https://arxiv.org/abs/2605.15040) | Agent 训练框架, 开源 | SWE-bench 67.5%，GUI/助手跨域统一 |
| 10 | [GraphFlow](https://arxiv.org/abs/2605.14968) | 可验证工作流, Agent 可靠性 | 形式化契约，临床试点 97.08% 完成率 |
| 14 | [LIFE Survey](https://arxiv.org/abs/2605.14892) | 多 Agent 综述, 自我进化 | 协作→归因→进化的因果链条 |
| 16 | [Agent 评估](https://arxiv.org/abs/2605.14865) | Agent 诊断, span 级评估 | 定位准确率 12.5x 提升 |
| 17 | [HS 分类 Agent](https://arxiv.org/abs/2605.14857) | 确定性 Agent 工作流, 可解释 | 固定控制流 + 局部 LLM 推理，6 位数 64.2% top-1 |
| 20 | [ARPM](https://arxiv.org/abs/2605.14802) | 记忆治理, 人设一致性 | 510 万字噪声基底 + 跨模型切换下保持一致性 |
| 22 | [MediaClaw](https://arxiv.org/abs/2605.14771) | 多模态 Agent 平台 | 基于 OpenClaw 生态的三层架构 |
