...
description: "2026-07-08 Agent 生态监测：1个框架工具、6个技术方向、1个应用场景。核心趋势：Memory从可选到标配，Multi-Agent协作模式成熟，Tool Learning从调用走向自主学习。"
...
| 分类 | 数量 | 代表项目/论文 |
|------|------|-------------|
| 框架/工具 | 1 | [A toy framework for single and multi-agent human-AI curiosity ecosystems](https://arxiv.org/abs/2607.06214) |
| 技术方向 | 6 | [DepthWeave-KV: Token-Adaptive ](https://arxiv.org/abs/2607.06523), [Bridging Physical Reasoning an](https://arxiv.org/abs/2607.06522) |
| 应用场景 | 1 | [Demonstrating TOFFEE: A Learne](https://arxiv.org/abs/2607.06233) |
| 理论研究 | 6 | [Doomed from the Start: Early A](https://arxiv.org/abs/2607.06503), [Multi-Agent Deep Reinforcement](https://arxiv.org/abs/2607.06489) |
...
| 项目 | 来源 | 描述 |
|------|------|------|
| [A toy framework for single and multi-agent human-AI curiosity ecosystems](https://arxiv.org/abs/2607.06214) | arXiv | agent,inquiry,curiosity,toy,framework,ecosystems,change,timescale,neurosciences, |
