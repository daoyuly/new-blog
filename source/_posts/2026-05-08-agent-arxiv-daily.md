...
- **arXiv ID**: [2605.06524](https://arxiv.org/abs/2605.06524)
- **研究方向**: other
- **核心要点**:
...
- **arXiv ID**: [2605.06490](https://arxiv.org/abs/2605.06490)
- **研究方向**: other
- **核心要点**:
...
- **arXiv ID**: [2605.06483](https://arxiv.org/abs/2605.06483)
- **研究方向**: other
- **核心要点**:
...
- **arXiv ID**: [2605.06457](https://arxiv.org/abs/2605.06457)
- **研究方向**: other
- **核心要点**:
...
- **arXiv ID**: [2605.06444](https://arxiv.org/abs/2605.06444)
...
- **arXiv ID**: [2605.06390](https://arxiv.org/abs/2605.06390)
- **研究方向**: safety
- **核心要点**:
...
- **arXiv ID**: [2605.06434](https://arxiv.org/abs/2605.06434)
- **研究方向**: memory
- **核心要点**:
...
1. [AI Co-Mathematician: Accelerating Mathematicians with Agentic AI](https://arxiv.org/abs/2605.06651) - other
2. [GlazyBench: A Benchmark for Ceramic Glaze Property Prediction and Image Generation](https://arxiv.org/abs/2605.06641) - evaluation
3. [Can RL Teach Long-Horizon Reasoning to LLMs? Expressiveness Is Key](https://arxiv.org/abs/2605.06638) - planning
4. [MASPO: Joint Prompt Optimization for LLM-based Multi-Agent Systems](https://arxiv.org/abs/2605.06623) - multi_agent
5. [SkillOS: Learning Skill Curation for Self-Evolving Agents](https://arxiv.org/abs/2605.06614) - other
6. [NeuroAgent: LLM Agents for Multimodal Neuroimaging Analysis and Research](https://arxiv.org/abs/2605.06584) - other
7. [Improved techniques for fine-tuning flow models via adjoint matching: a deterministic control pipeline](https://arxiv.org/abs/2605.06583) - safety
8. [SpatialEpiBench: Benchmarking Spatial Information and Epidemic Priors in Forecasting](https://arxiv.org/abs/2605.06530) - evaluation
9. [Market-Alignment Risk in Pricing Agents: Trace Diagnostics and Trace-Prior RL under Hidden Competitor State](https://arxiv.org/abs/2605.06529) - safety
10. [Process Matters more than Output for Distinguishing Humans from Machines](https://arxiv.org/abs/2605.06524) - other
11. [Instrumental Choices: Measuring the Propensity of LLM Agents to Pursue Instrumental Behaviors](https://arxiv.org/abs/2605.06490) - other
12. [ReasonSTL: Bridging Natural Language and Signal Temporal Logic via Tool-Augmented Process-Rewarded Learning](https://arxiv.org/abs/2605.06483) - other
13. [Beyond Task Success: Measuring Workflow Fidelity in LLM-Based Agentic Payment Systems](https://arxiv.org/abs/2605.06457) - other
14. [PrefixGuard: From LLM-Agent Traces to Online Failure-Warning Monitors](https://arxiv.org/abs/2605.06455) - other
15. [SCRuB: Social Concept Reasoning under Rubric-Based Evaluation](https://arxiv.org/abs/2605.06444) - planning, evaluation
16. [Knowledge Graphs, the Missing Link in Agentic AI-based Formal Verification](https://arxiv.org/abs/2605.06434) - memory
17. [Automated alignment is harder than you think](https://arxiv.org/abs/2605.06390) - safety
18. [From Agent Loops to Deterministic Graphs: Execution Lineage for Reproducible AI-Native Work](https://arxiv.org/abs/2605.06365) - other
