...
description: "2026-06-10 Agent Harness 领域监测：16项动态，评测与可观测9项、框架与运行时9项、编排与工作流1项。基于Agent Harness成熟度模型(AHMM)和编排四范式分析。核心判断：MCP成为工具接入事实标准，L2→L3是当前最大跳跃。"
...
| 项目/论文 | 来源 | 核心描述 | 工程启示 |
|-----------|------|---------|----------|
| [ABC-Bench: An Agentic Bio-Capabilities B](https://arxiv.org/abs/2606.11150) | arXiv | biosecurity,agentic,abc,bench,capabilities,tasks,dna,agents, | 评估闭环是关键 |
| [Monte Carlo Pass Search: Using Trajector](https://arxiv.org/abs/2606.11120) | arXiv | pass,ball,football,evaluation,variants,scores,monte,carlo,co | 评估闭环是关键 |
| [CIAware-Bench: Benchmarking Control Inte](https://arxiv.org/abs/2606.11063) | arXiv | ciaware,awareness,bench,control,intervention,frontier,textbf | 评估闭环是关键 |
| [What Fits (Into Few Tokens) Doesn&#039;t](https://arxiv.org/abs/2606.11045) | arXiv | overfitting,compression,hypothesis,reproduce,bottlenecks,rep | 评估闭环是关键 |
| [Workflow-GYM: Towards Long-Horizon Evalu](https://arxiv.org/abs/2606.11042) | arXiv | professional,gui,horizon,workflow,agents,gym,software,tasks, | DAG编排成主流 |
| [Recalling Too Well: Sycophancy Evaluatio](https://arxiv.org/abs/2606.10949) | arXiv | sycophancy,memory,misconceptions,recalling,sycophantic,evalu | 评估闭环是关键 |
| [Do VLMs Reason Like Engineers? A Benchma](https://arxiv.org/abs/2606.10833) | arXiv | reasoning,engineering,vlms,evaluation,multimodal,stage,bench | 评估闭环是关键 |
| [Evaluating Research-Level Math Proofs vi](https://arxiv.org/abs/2606.10799) | arXiv | proofs,logical,verification,global,level,strict,step,prompti | 评估闭环是关键 |
