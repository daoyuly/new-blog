...
- **arXiv ID**: [2605.15177](https://arxiv.org/abs/2605.15177)
- **研究方向**: planning
- **核心要点**:
...
- **arXiv ID**: [2605.15100](https://arxiv.org/abs/2605.15100)
- **研究方向**: planning
- **核心要点**:
...
- **arXiv ID**: [2605.15041](https://arxiv.org/abs/2605.15041)
- **研究方向**: planning, tool
- **核心要点**:
...
- **arXiv ID**: [2605.14857](https://arxiv.org/abs/2605.14857)
- **研究方向**: planning
- **核心要点**:
...
- **arXiv ID**: [2605.14754](https://arxiv.org/abs/2605.14754)
- **研究方向**: planning
- **核心要点**:
...
- **arXiv ID**: [2605.15132](https://arxiv.org/abs/2605.15132)
- **研究方向**: other
- **核心要点**:
...
- **arXiv ID**: [2605.14968](https://arxiv.org/abs/2605.14968)
- **研究方向**: other
- **核心要点**:
...
- **arXiv ID**: [2605.14771](https://arxiv.org/abs/2605.14771)
- **研究方向**: other
- **核心要点**:
...
- **arXiv ID**: [2605.15109](https://arxiv.org/abs/2605.15109)
- **研究方向**: memory
- **核心要点**:
...
- **arXiv ID**: [2605.14912](https://arxiv.org/abs/2605.14912)
- **研究方向**: safety
- **核心要点**:
...
- **arXiv ID**: [2605.14758](https://arxiv.org/abs/2605.14758)
- **研究方向**: multi_agent
- **核心要点**:
...
- **arXiv ID**: [2605.14865](https://arxiv.org/abs/2605.14865)
- **研究方向**: evaluation
- **核心要点**:
...
1. [OpenDeepThink: Parallel Reasoning via Bradley--Terry Aggregation](https://arxiv.org/abs/2605.15177) - planning
2. [APWA: A Distributed Architecture for Parallelizable Agentic Workflows](https://arxiv.org/abs/2605.15132) - other
3. [Why Neighborhoods Matter: Traversal Context and Provenance in Agentic GraphRAG](https://arxiv.org/abs/2605.15109) - memory
4. [Dual-Dimensional Consistency: Balancing Budget and Quality in Adaptive Inference-Time Scaling](https://arxiv.org/abs/2605.15100) - planning
5. [Case-Based Calibration of Adaptive Reasoning and Execution for LLM Tool Use](https://arxiv.org/abs/2605.15041) - planning, tool
6. [Orchard: An Open-Source Agentic Modeling Framework](https://arxiv.org/abs/2605.15040) - other
7. [GraphFlow: An Architecture for Formally Verifiable Visual Workflows Enabling Reliable Agentic AI Automation](https://arxiv.org/abs/2605.14968) - other
8. [From Sycophantic Consensus to Pluralistic Repair: Why AI Alignment Must Surface Disagreement](https://arxiv.org/abs/2605.14912) - safety
9. [Beyond Individual Intelligence: Surveying Collaboration, Failure Attribution, and Self-Evolution in LLM-based Multi-Agent Systems](https://arxiv.org/abs/2605.14892) - multi_agent
10. [Holistic Evaluation and Failure Diagnosis of AI Agents](https://arxiv.org/abs/2605.14865) - evaluation
11. [A Deterministic Agentic Workflow for HS Tariff Classification: Multi-Dimensional Rule Reasoning with Interpretable Decisions](https://arxiv.org/abs/2605.14857) - planning
12. [MediaClaw: Multimodal Intelligent-Agent Platform Technical Report](https://arxiv.org/abs/2605.14771) - other
13. [Probabilistic Verification of Recurrent Neural Networks for Single and Multi-Agent Reinforcement Learning](https://arxiv.org/abs/2605.14758) - multi_agent
14. [XDomainBench: Diagnosing Reasoning Collapse in High-Dimensional Scientific Knowledge Composition](https://arxiv.org/abs/2605.14754) - planning
