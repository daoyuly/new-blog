...
description: "2026-06-17 Agent Harness 领域监测：13项动态，框架与运行时9项、评测与可观测5项、多智能体协作2项。基于Agent Harness成熟度模型(AHMM)和编排四范式分析。核心判断：MCP成为工具接入事实标准，L2→L3是当前最大跳跃。"
...
| 项目/论文 | 来源 | 核心描述 | 工程启示 |
|-----------|------|---------|----------|
| [OpenClaw-Skill: Collective Skill Tree Se](https://arxiv.org/abs/2606.16774) | arXiv | skill,skills,csn,collective,csts,openclaw,tree,agentic,scori | 关注架构演进方向 |
...
| 项目/论文 | 来源 | 核心描述 | 工程启示 |
|-----------|------|---------|----------|
| [Bayesian Inference and Decision Audits f](https://arxiv.org/abs/2606.17005) | arXiv | archives,terminal,frontier,public,audits,reporting,livebench | 评估闭环是关键 |
| [LabOSBench: Benchmarking Computer Use Ag](https://arxiv.org/abs/2606.16802) | arXiv | labosbench,agents,scientific,instrument,gui,computer,subtask | 评估闭环是关键 |
| [CoffeeBench: Benchmarking Long-Horizon L](https://arxiv.org/abs/2606.16613) | arXiv | coffeebench,agent,agents,firms,horizon,llm,economic,income,r | 多Agent协作框架演进 |
| [ARB4WM: An Adversarial Robustness Benchm](https://arxiv.org/abs/2606.16605) | arXiv | arb4wm,robustness,world,objectives,adversarial,latent,agents | 评估闭环是关键 |
| [Show HN: VoltAgent – Open-Source Observa](https://github.com/VoltAgent/voltagent) | HN | Show HN: VoltAgent – Open-Source Observability-First TS AI A | 向L3可观测演进 |
