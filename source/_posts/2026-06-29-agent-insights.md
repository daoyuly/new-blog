...
| 分类 | 数量 | 代表项目/论文 |
|------|------|-------------|
| 框架/工具 | 1 | [Towards Reliable and Robust LLM Planning: Symbolic Feedback-Driven Iterative Self-Refinement Framework](https://arxiv.org/abs/2606.27757) |
| 技术方向 | 6 | [Tandem Reinforcement Learning ](https://arxiv.org/abs/2606.28166), [NormAct: A Benchmark for Hidde](https://arxiv.org/abs/2606.27826) |
| 应用场景 | 1 | [Agentic Hardware Design as Rep](https://arxiv.org/abs/2606.28279) |
| 理论研究 | 3 | [Agent-Native Immune System: Ar](https://arxiv.org/abs/2606.28270), [ATOD: Annealed Turn-aware On-p](https://arxiv.org/abs/2606.27814) |
...
| 项目 | 来源 | 描述 |
|------|------|------|
| [Towards Reliable and Robust LLM Planning: Symbolic Feedback-Driven Iterative Self-Refinement Framework](https://arxiv.org/abs/2606.27757) | arXiv | planning,llm,symbolic,refinement,llms,reliability,horizon,self,feedback,iterativ |
