...
description: "做系统设计时，\"事件驱动\"\"模型驱动\"\"响应式驱动\"\"状态机驱动\"这几个词经常被混着用。它们确实有交集，但骨子里的思考方式完全不同。这篇从技术机制出发，把这些范式的异同讲清楚。"
keywords: "事件·llm·状态机·响应式, 四种驱动范式的骨相, architecture, event-driven, model-driven, state-machine, reactive, paradigm"
---
