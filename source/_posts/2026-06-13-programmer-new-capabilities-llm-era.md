...
description: "大模型不是让程序员失业的工具，而是让程序员的价值锚点发生位移的催化剂。过去衡量一个程序员的核心标准是\"能不能写出来\"，现在这个标准正在被改写——代码实现本身正在被 AI 大规模接管，真正稀缺的，是写代码之前和之后的那几步。"
keywords: "大模型时代程序员的四项全新能力要求, LLM, 程序员, 能力模型, AI 时代, 职业发展, AI, Career"
---
