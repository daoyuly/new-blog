...
description: "2026-06-03 Agent Harness 领域监测：14项动态，框架与运行时8项、评测与可观测6项、工具与协议2项。基于Agent Harness成熟度模型(AHMM)和编排四范式分析。核心判断：MCP成为工具接入事实标准，L2→L3是当前最大跳跃。"
...
| 项目/论文 | 来源 | 核心描述 | 工程启示 |
|-----------|------|---------|----------|
| [Hedge-Bench: Benchmarking Agents on Hard](https://arxiv.org/abs/2606.03918) | arXiv | hedge,trata,bench,reasoning,agents,financial,tasks,ended,per | 评估闭环是关键 |
| [scTranslation: A Comprehensive Benchmark](https://arxiv.org/abs/2606.03906) | arXiv | sctranslation,omics,translation,modality,comprehensive,bench | 评估闭环是关键 |
| [BigFinanceBench: A Workflow-Grounded Ben](https://arxiv.org/abs/2606.03829) | arXiv | bigfinancebench,rubric,financial,workflow,derivation,analyst | DAG编排成主流 |
| [From Answers to States: Verifiable Proce](https://arxiv.org/abs/2606.03660) | arXiv | verifiable,reasoning,verifier,chemical,chemcotbench,answer,c | 评估闭环是关键 |
| [Diagnosing Knowledge Gaps in LLM Tool Us](https://arxiv.org/abs/2606.03657) | arXiv | knowledge,api,apis,retrieval,executable,agentic,tuning,use,d | 评估闭环是关键 |
| [Show HN: VoltAgent – Open-Source Observa](https://github.com/VoltAgent/voltagent) | HN | Show HN: VoltAgent – Open-Source Observability-First TS AI A | 向L3可观测演进 |
...
| 项目/论文 | 来源 | 核心描述 | 工程启示 |
|-----------|------|---------|----------|
| [LAP: An Agent-to-Instrument Protocol for](https://arxiv.org/abs/2606.03755) | arXiv | lap,agent,a2a,protocol,instrument,mcp,autonomous,safety,qudt | MCP 生态值得关注 |
| [Diagnosing Knowledge Gaps in LLM Tool Us](https://arxiv.org/abs/2606.03657) | arXiv | knowledge,api,apis,retrieval,executable,agentic,tuning,use,d | 评估闭环是关键 |
