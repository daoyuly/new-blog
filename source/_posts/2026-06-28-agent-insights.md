...
description: "2026-06-28 Agent 生态监测：0个框架工具、2个技术方向、1个应用场景。核心趋势：Memory从可选到标配，Multi-Agent协作模式成熟，Tool Learning从调用走向自主学习。"
...
|------|------|-------------|
| 框架/工具 | 0 |  |
| 技术方向 | 2 | [Einstein World Models](https://arxiv.org/abs/2606.26969), [Where Do CoT Training Gains La](https://arxiv.org/abs/2606.26935) |
| 应用场景 | 1 | [A Process Harness for Upliftin](https://arxiv.org/abs/2606.27188) |
| 理论研究 | 6 | [When Does Combining Language M](https://arxiv.org/abs/2606.27288), [Joint Learning of Experiential](https://arxiv.org/abs/2606.27136) |
