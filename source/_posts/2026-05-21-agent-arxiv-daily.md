...
- **arXiv ID**: [2605.21482](https://arxiv.org/abs/2605.21482)
...
- **arXiv ID**: [2605.21413](https://arxiv.org/abs/2605.21413)
- **研究方向**: evaluation
- **核心要点**:
...
- **arXiv ID**: [2605.21347](https://arxiv.org/abs/2605.21347)
- **研究方向**: other
- **核心要点**:
...
- **arXiv ID**: [2605.20911](https://arxiv.org/abs/2605.20911)
- **研究方向**: other
- **核心要点**:
...
- **arXiv ID**: [2605.20874](https://arxiv.org/abs/2605.20874)
- **研究方向**: other
- **核心要点**:
...
- **arXiv ID**: [2605.20742](https://arxiv.org/abs/2605.20742)
- **研究方向**: other
- **核心要点**:
...
- **arXiv ID**: [2605.20690](https://arxiv.org/abs/2605.20690)
- **研究方向**: other
- **核心要点**:
...
- **arXiv ID**: [2605.20608](https://arxiv.org/abs/2605.20608)
- **研究方向**: other
- **核心要点**:
...
- **arXiv ID**: [2605.20554](https://arxiv.org/abs/2605.20554)
- **研究方向**: other
- **核心要点**:
...
- **arXiv ID**: [2605.20530](https://arxiv.org/abs/2605.20530)
- **研究方向**: other
- **核心要点**:
...
- **arXiv ID**: [2605.20784](https://arxiv.org/abs/2605.20784)
- **研究方向**: planning
- **核心要点**:
...
- **arXiv ID**: [2605.20618](https://arxiv.org/abs/2605.20618)
- **研究方向**: multi_agent
- **核心要点**:
...
1. [DeepWeb-Bench: A Deep Research Benchmark Demanding Massive Cross-Source Evidence and Long-Horizon Derivation](https://arxiv.org/abs/2605.21482) - memory, evaluation
2. [Teaching AI Through Benchmark Construction: QuestBench as a Course-Based Practice for Accountable Knowledge Work](https://arxiv.org/abs/2605.21413) - evaluation
3. [Insights Generator: Systematic Corpus-Level Trace Diagnostics for LLM Agents](https://arxiv.org/abs/2605.21347) - other
4. [For How Long Should We Be Punching? Learning Action Duration in Fighting Games](https://arxiv.org/abs/2605.20911) - other
5. [Governance by Construction for Generalist Agents](https://arxiv.org/abs/2605.20874) - other
6. [PlanningBench: Generating Scalable and Verifiable Planning Data for Evaluating and Training Large Language Models](https://arxiv.org/abs/2605.20873) - planning
7. [Conditional Equivalence of DPO and RLHF: Implicit Assumption, Failure Modes, and Provable Alignment](https://arxiv.org/abs/2605.20834) - safety
8. [Interaction Locality in Hierarchical Recursive Reasoning](https://arxiv.org/abs/2605.20784) - planning
9. [VBFDD-Agent for Electric Vehicle Battery Fault Detection and Diagnosis: Descriptive Text Modeling of Battery Digital Signals](https://arxiv.org/abs/2605.20742) - other
10. [Declarative Data Services: Structured Agentic Discovery for Composing Data Systems](https://arxiv.org/abs/2605.20690) - other
11. [Evaluating Temporal Semantic Caching and Workflow Optimization in Agentic Plan-Execute Pipelines](https://arxiv.org/abs/2605.20630) - other
12. [COAgents: Multi-Agent Framework to Learn and Navigate Routing Problems Search Space](https://arxiv.org/abs/2605.20618) - multi_agent
13. [From Automated to Autonomous: Hierarchical Agent-native Network Architecture (HANA)](https://arxiv.org/abs/2605.20608) - other
14. [Personality Engineering with AI Agents: A New Methodology for Negotiation Research](https://arxiv.org/abs/2605.20554) - other
15. [AgentAtlas: Beyond Outcome Leaderboards for LLM Agents](https://arxiv.org/abs/2605.20530) - other
