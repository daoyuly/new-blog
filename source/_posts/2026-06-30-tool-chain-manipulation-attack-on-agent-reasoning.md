...
1. **ToolSword: Unveiling Safety Issues of Large Language Models in Tool Learning Across Three Stages** — Junjie Ye et al., ACL 2024. 系统性研究 LLM 在工具学习三个阶段（输入、执行、输出）的安全问题，覆盖恶意查询、越狱攻击、噪声误导、风险提示、有害反馈和错误冲突六类场景。[arXiv:2402.10753](https://arxiv.org/abs/2402.10753)
...
8. **PoisonedRAG: Knowledge Poisoning Attacks on Retrieval-Augmented Generation** — Wei Zou et al., 2024. 研究 RAG 系统中的知识投毒攻击，与工具返回值注入有相似的攻击原理。[arXiv:2402.07867](https://arxiv.org/abs/2402.07867)

9. **AgentPoison: Red-Teaming LLM Agents via Poisoning Memory or Knowledge Bases** — Zhaorun Chen et al., 2024. 通过投毒记忆或知识库来红队测试 LLM Agent，展示了间接数据操纵的攻击潜力。[arXiv:2407.12784](https://arxiv.org/abs/2407.12784)
