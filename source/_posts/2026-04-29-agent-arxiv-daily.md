...
- **arXiv ID**: [2604.25832](https://arxiv.org/abs/2604.25832)
- **研究方向**: evaluation
- **核心要点**:
...
- **arXiv ID**: [2604.25614](https://arxiv.org/abs/2604.25614)
- **研究方向**: evaluation
- **核心要点**:
...
- **arXiv ID**: [2604.25472](https://arxiv.org/abs/2604.25472)
- **研究方向**: evaluation
- **核心要点**:
...
- **arXiv ID**: [2604.25512](https://arxiv.org/abs/2604.25512)
- **研究方向**: planning
- **核心要点**:
...
1. [Recursive Multi-Agent Systems](https://arxiv.org/abs/2604.25917) - multi_agent
2. [ADEMA: A Knowledge-State Orchestration Architecture for Long-Horizon Knowledge Synthesis with LLMAgents](https://arxiv.org/abs/2604.25849) - other
3. [TrialCalibre: A Fully Automated Causal Engine for RCT Benchmarking and Observational Trial Calibration](https://arxiv.org/abs/2604.25832) - evaluation
4. [StratFormer: Adaptive Opponent Modeling and Exploitation in Imperfect-Information Games](https://arxiv.org/abs/2604.25796) - other
5. [Scalable Inference Architectures for Compound AI Systems: A Production Deployment Study](https://arxiv.org/abs/2604.25724) - other
6. [RADD: Retrieval-Augmented Discrete Diffusion for Multi-Modal Knowledge Graph Completion](https://arxiv.org/abs/2604.25693) - memory
7. [Think Before You Act -- A Neurocognitive Governance Model for Autonomous AI Agents](https://arxiv.org/abs/2604.25684) - other
8. [HotComment: A Benchmark for Evaluating Popularity of Online Comments](https://arxiv.org/abs/2604.25614) - evaluation
9. [OxyGent: Making Multi-Agent Systems Modular, Observable, and Evolvable via Oxy Abstraction](https://arxiv.org/abs/2604.25602) - multi_agent
10. [PHISHREV: A Hybrid Machine Learning and Post-Hoc Non-monotonic Reasoning Framework for Context-Aware Phishing Website Classification](https://arxiv.org/abs/2604.25512) - planning
11. [SciEval: A Benchmark for Automatic Evaluation of K-12 Science Instructional Materials](https://arxiv.org/abs/2604.25472) - evaluation
12. [Plausible but Wrong: A case study on Agentic Failures in Astrophysical Workflows](https://arxiv.org/abs/2604.25345) - other
13. [AutoResearchBench: Benchmarking AI Agents on Complex Scientific Literature Discovery](https://arxiv.org/abs/2604.25256) - evaluation
