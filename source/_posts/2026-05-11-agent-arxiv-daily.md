...
- **arXiv ID**: [2605.08070](https://arxiv.org/abs/2605.08070)
- **研究方向**: planning
- **核心要点**:
...
- **arXiv ID**: [2605.08061](https://arxiv.org/abs/2605.08061)
- **研究方向**: planning
- **核心要点**:
...
- **arXiv ID**: [2605.08011](https://arxiv.org/abs/2605.08011)
- **研究方向**: planning
- **核心要点**:
...
- **arXiv ID**: [2605.07926](https://arxiv.org/abs/2605.07926)
- **研究方向**: planning
- **核心要点**:
...
- **arXiv ID**: [2605.07744](https://arxiv.org/abs/2605.07744)
...
- **arXiv ID**: [2605.07707](https://arxiv.org/abs/2605.07707)
- **研究方向**: planning
- **核心要点**:
...
- **arXiv ID**: [2605.07584](https://arxiv.org/abs/2605.07584)
...
- **arXiv ID**: [2605.07521](https://arxiv.org/abs/2605.07521)
- **研究方向**: planning
- **核心要点**:
...
- **arXiv ID**: [2605.08019](https://arxiv.org/abs/2605.08019)
- **研究方向**: safety
- **核心要点**:
...
- **arXiv ID**: [2605.08013](https://arxiv.org/abs/2605.08013)
- **研究方向**: other
- **核心要点**:
...
- **arXiv ID**: [2605.07935](https://arxiv.org/abs/2605.07935)
- **研究方向**: multi_agent
- **核心要点**:
...
1. [VecCISC: Improving Confidence-Informed Self-Consistency with Reasoning Trace Clustering and Candidate Answer Selection](https://arxiv.org/abs/2605.08070) - planning
2. [Rubric-Grounded RL: Structured Judge Rewards for Generalizable Reasoning](https://arxiv.org/abs/2605.08061) - planning
3. [Reason to Play: Behavioral and Brain Alignment Between Frontier LRMs and Human Game Learners](https://arxiv.org/abs/2605.08019) - safety
4. [Learning CLI Agents with Structured Action Credit under Selective Observation](https://arxiv.org/abs/2605.08013) - other
5. [Abductive Reasoning with Probabilistic Commonsense](https://arxiv.org/abs/2605.08011) - planning
6. [TraceFix: Repairing Agent Coordination Protocols with TLA+ Counterexamples](https://arxiv.org/abs/2605.07935) - multi_agent
7. [AgentEscapeBench: Evaluating Out-of-Domain Tool-Grounded Reasoning in LLM Agents](https://arxiv.org/abs/2605.07926) - planning
8. [RuleSafe-VL: Evaluating Rule-Conditioned Decision Reasoning in Vision-Language Content Moderation](https://arxiv.org/abs/2605.07760) - planning
9. [Alternating Target-Path Planning for Scalable Multi-Agent Coordination](https://arxiv.org/abs/2605.07744) - planning, multi_agent
10. [Hierarchical Task Network Planning with LLM-Generated Heuristics](https://arxiv.org/abs/2605.07707) - planning
11. [Finite-Time Analysis of MCTS in Continuous POMDP Planning](https://arxiv.org/abs/2605.07703) - planning
12. [GASim: A Graph-Accelerated Hybrid Framework for Social Simulation](https://arxiv.org/abs/2605.07692) - memory
13. [Learning to Communicate Locally for Large-Scale Multi-Agent Pathfinding](https://arxiv.org/abs/2605.07637) - multi_agent
14. [Parallel Lifted Planning via Semi-Naive Datalog Evaluation](https://arxiv.org/abs/2605.07584) - planning, evaluation
15. [From Feasible to Practical: Pareto-Optimal Synthesis Planning](https://arxiv.org/abs/2605.07521) - planning
