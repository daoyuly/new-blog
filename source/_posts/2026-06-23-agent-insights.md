...
description: "2026-06-23 Agent 生态监测：0个框架工具、8个技术方向、0个应用场景。核心趋势：Memory从可选到标配，Multi-Agent协作模式成熟，Tool Learning从调用走向自主学习。"
...
|------|------|-------------|
| 框架/工具 | 0 |  |
| 技术方向 | 8 | [SPIRAL: Learning to Search and](https://arxiv.org/abs/2606.23595), [VeriEvol: Scaling Multimodal M](https://arxiv.org/abs/2606.23543) |
| 应用场景 | 0 |  |
| 理论研究 | 3 | [Causal Discovery in the Era of](https://arxiv.org/abs/2606.23608), [AOHP: An Open-Source OS-Level ](https://arxiv.org/abs/2606.23449) |
