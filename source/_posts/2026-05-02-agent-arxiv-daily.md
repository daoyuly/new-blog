...
- **arXiv ID**: [2604.28039](https://arxiv.org/abs/2604.28039)
- **研究方向**: evaluation
- **核心要点**:
...
- **arXiv ID**: [2604.28082](https://arxiv.org/abs/2604.28082)
- **研究方向**: safety
- **核心要点**:
...
- **arXiv ID**: [2604.27964](https://arxiv.org/abs/2604.27964)
- **研究方向**: planning
- **核心要点**:
...
- **arXiv ID**: [2604.27960](https://arxiv.org/abs/2604.27960)
- **研究方向**: planning
- **核心要点**:
...
1. [Synthetic Computers at Scale for Long-Horizon Productivity Simulation](https://arxiv.org/abs/2604.28181) - other
2. [What Makes a Good Terminal-Agent Benchmark Task: A Guideline for Adversarial, Difficult, and Legible Evaluation Design](https://arxiv.org/abs/2604.28093) - evaluation
3. [Characterizing the Consistency of the Emergent Misalignment Persona](https://arxiv.org/abs/2604.28082) - safety
4. [Agent-Agnostic Evaluation of SQL Accuracy in Production Text-to-SQL Systems](https://arxiv.org/abs/2604.28049) - evaluation
5. [Collaborative Agent Reasoning Engineering (CARE): A Three-Party Design Methodology for Systematically Engineering AI Agents with Subject Matter Experts, Developers, and Helper Agents](https://arxiv.org/abs/2604.28043) - planning
6. [SpecVQA: A Benchmark for Spectral Understanding and Visual Question Answering in Scientific Images](https://arxiv.org/abs/2604.28039) - evaluation
7. [A Pattern Language for Resilient Visual Agents](https://arxiv.org/abs/2604.28001) - other
8. [Exploring Interaction Paradigms for LLM Agents in Scientific Visualization](https://arxiv.org/abs/2604.27996) - other
9. [D3-Gym: Constructing Real-World Verifiable Environments for Data-Driven Discovery](https://arxiv.org/abs/2604.27977) - evaluation
10. [Splitting Assumption-Based Argumentation Frameworks](https://arxiv.org/abs/2604.27964) - planning
11. [LLMs as ASP Programmers: Self-Correction Enables Task-Agnostic Nonmonotonic Reasoning](https://arxiv.org/abs/2604.27960) - planning
12. [GUI Agents with Reinforcement Learning: Toward Digital Inhabitants](https://arxiv.org/abs/2604.27955) - other
13. [A Collective Variational Principle Unifying Bayesian Inference, Game Theory, and Thermodynamics](https://arxiv.org/abs/2604.27942) - other
14. [MM-StanceDet: Retrieval-Augmented Multi-modal Multi-agent Stance Detection](https://arxiv.org/abs/2604.27934) - memory, planning, multi_agent
